...
public:
	...
	User(int userId, std::string userName, std::string password, std::string role) : m_userId{ userId }, m_userName{ userName }, m_password{ password }, m_role{ role }, m_userStatus{ "Active" }{}
	std::string getRole();
